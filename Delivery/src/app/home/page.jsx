...
const AllOrders = () => {
    ...
    return (
        <div className='container mx-auto px-4'>
            <h1 className='text-xl font-semibold text-center py-4'>All Orders</h1>
                        ...
                        {orders?.Orders?.slice().reverse().map((item) => {
                            ...
                            return (
                                <tr key={item.orderId} onClick={() => {
                                    ...
                                    <td className="px-4 py-2">
                                        <a href={`tel:${item.phoneNumber}`} className="text-sm text-blue-500 underline">
                                            {item.phoneNumber}
                                        </a>
                                    </td>
                                                            ...
                                                            <tr>
                                                                <td className="border px-2 py-1">
                                                                    ...
                                                                    <h1 className="text-xs">
                                                                        Number:
                                                                        <a
                                                                            href={`tel:${shopInfo?.shopUser?.phoneNumber || ""}`}
                                                                            className="text-blue-500 underline"
                                                                        >
                                                                            {shopInfo?.shopUser?.phoneNumber || "Shop Number"}
                                                                        </a>
                                                                    </h1>
